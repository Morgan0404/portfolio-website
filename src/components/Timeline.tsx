        ...
        <ol className=" relative border-l-4 border-blue-600 dark:border-blue-700">
            ...
            <li className=" mb-10 ms-4 ">
                ...
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                    ...
                    The program is designed to reflect the entire Computer Science development cycle—from theory and design to development, testing, and application—ensuring a comprehensive and relevant learning experience.
                </p>
                <a
                    href="/uni"
